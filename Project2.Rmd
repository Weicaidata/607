...
load csv dataset by Sunny Mehta into R
...
rename the columns for better understanding the data, and use glimpse function in dplyr to examine the dataset
```{r}
...
##answer question" states sale trend"
...
NY has most the sales volume compare to others, the sales of other states are more steady all over the year.
```{r}
